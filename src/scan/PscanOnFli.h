...
enum class BlockExecutionMode { Disabled, SeedOnly, SkipCertified, WitnessBounds, AdaptiveWitnessBounds, WitnessBitmaps, WitnessExclusion, LazyNoWitness, LazyAlwaysExclusion, CoreConnectivity };
