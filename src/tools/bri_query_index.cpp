...
int main(int argc, char** argv) {
    ...
    try {
        ...
        std::cout << "index_mode=base_relation_on_demand_fli\n"
                  ...
                  << "resumable_neighborhoods=" << (HINSCAN_BLOCK_MODE == 13) << '\n'
                  ...
                  << "resume_checks=" << q.adaptive_cache.resume_checks << '\n'
                  << "resume_hits=" << q.adaptive_cache.resume_hits << '\n'
                  << "resume_new_rows=" << q.adaptive_cache.resume_new_rows << '\n'
                  << "resume_replay_units=" << q.adaptive_cache.resume_replay_units << '\n'
                  << "resume_new_entries=" << q.adaptive_cache.resume_new_entries << '\n'
                  << "resume_skipped_prefix_entries=" << q.adaptive_cache.resume_skipped_prefix_entries << '\n'
                  << "resume_partial_saves=" << q.adaptive_cache.resume_partial_saves << '\n'
                  << "resume_partial_drops=" << q.adaptive_cache.resume_partial_drops << '\n'
                  << "resume_partial_evictions=" << q.adaptive_cache.resume_partial_evictions << '\n'
                  << "resume_promotions=" << q.adaptive_cache.resume_promotions << '\n'
                  << "resume_left_completions=" << q.adaptive_cache.resume_left_completions << '\n'
                  << "resume_replay_ms=" << q.adaptive_cache.resume_replay_ms << '\n'
                  << "resume_save_ms=" << q.adaptive_cache.resume_save_ms << '\n'
